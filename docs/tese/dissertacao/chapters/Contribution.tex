...
\highlight{Validação de resultados}
...
% calculo de direcao de rotacao

% calculo de angulo de rotacao
%% correcoes menores utilizando leptonica
...
\highlight{Identificação de elementos de imagem}
\label{contribution_image_element_identification}

% delimitadores
%% descoberta de delimitadores
%% limpeza/redução de delimitadores

% imagens

\highlight{Segmentação de imagem}
\label{contribution_image_segmentation}

% divisao de colunas

% divisao de template usando delimitadores
...
% conversores de resultados para text e markdown
