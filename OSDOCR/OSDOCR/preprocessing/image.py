...
def run_waifu2x(target_image:str,method:str='scale2x',model_type:str='photo',noise_level:int=1,result_image_path:str=None) -> str:
...
def run_degan_old_docs(target_image:str,result_image_path:str=None,method:str='binarize') -> str:
